                        ...
                        <portal-card title="Как продаются и активируются бумажные сертификаты">
                            <div class="content">
                                <ul>
                                    ...
                                    <li>У каждого филиала — своя нумерация, которая записана в таблице "Поиск по сертификатам"</li>
                    ...
                    <div class="col-12">
                        <portal-card title="Как работать с таблицей сертификатов">
                            <div class="content">
                                ...
                                <p>Если возникают ошибки при пробитии в Yclients, таблица поможет проверить корректность и выявить расхождения.</p>
                            </div>
                        </portal-card>

                        <portal-card title="Взаиморасчеты по сертификатам">
                            <div class="content">
                                <p>Если клиент использует сертификат в другом филиале (не в том, где он был куплен), принимающий филиал получает 50% от суммы визита от филиала-продавца.</p>
                            </div>
                        </portal-card>
