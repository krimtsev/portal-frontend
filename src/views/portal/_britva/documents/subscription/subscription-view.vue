        ...
        <div class="grid">
            <div class="col-8">
                ...
                <portal-card title="Важно знать!">
                     <div class="content">
                        <ul>
                            ...
                            <li>Вознаграждение сотрудников составляет 40% от стоимости конкретной услуги, оплаченной по абонементу.</li>
                        </ul>
                    </div>
                    ...
                    <div class="content">
                        <ul>
                            <li>В системе Yclients у каждого филиала создаётся категория: Абонементы // СЕТЬ BRITVA</li>
                            ...
                            <li>Необходимо обновить схемы расчёта: — от продажи товаров (кроме абонементов) — 10% — от продажи абонементов — 0%</li>
                        </ul>
                    </div>
                ...
                <portal-card title="Продажа абонемента">
                    ...
                    <div class="content">
                        <ul>
                            <li>При первом посещении абонемент автоматически привязывается к номеру телефона клиента</li>
                    ...
                    <div class="content">
                        <ul>
                            ...
                            <li>Перейдите во вкладку «Лояльность» — там отображается количество оставшихся стрижек по абонементу</li>
                        </ul>
                    </div>
                </portal-card>
            </div>
